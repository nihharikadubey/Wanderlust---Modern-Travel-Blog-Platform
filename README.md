# Wanderlust - Modern Travel Blog Platform 🌍✈️
...
- **Modern Tech Stack**: Built with MERN (MongoDB, Express.js, React, Node.js)
- **DevSecOps Pipeline**: Automated build, test, scan and deploy workflow
- **GitOps with ArgoCD**: Declarative continuous deployment to Kubernetes
- **Enterprise-grade Security**: OWASP dependency checks and Trivy container scanning
- **Production Monitoring**: Prometheus & Grafana dashboards for observability
- **High Availability**: Deployed on AWS EKS with auto-scaling
...
![Preview Image](Assets/DevSecOps+GitOps.gif)
